...
psql -d bikes -c "CREATE TABLE IF NOT EXISTS raw_json_data (timestamp TIMESTAMP, json_data JSON);"
...
do
    ...
    then
        ...
        echo "INSERT INTO raw_json_data (timestamp, json_data) VALUES ('$timestamp', '$line');" >> $temp_file
    fi
done < $input_file
